#!/bin/bash
USAGE="Usage: list.sh [-h service-broker-url] [-u username] [-c password]"
...
curl -s -H 'x-broker-api-version: 2.4' -X GET http://$SERVICE_BROKER_USERNAME:$SERVICE_BROKER_PASSWORD@$HOST/v2/service_instances
